...
<?php echo form_open_multipart("Blog_Controller/do_update/$blogid");?>
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Title:</label>
                    <div class="col-sm-10">
                      <input type="text" name="blogheading" id="blogheading" value="<?php echo $blogheading; ?>" class="form-control">
                    </div>
                  </div>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <textarea rows="9" name="blogtext" id="blogtext" class="form-control"><?php echo $blogcontent; ?></textarea>
                    </div>
                  </div> 
                    ...
                    <div class="col-sm-10">
                      <textarea rows="2" name="blogsummary" id="blogsummary" class="form-control"><?php echo $blogsummary; ?></textarea>
                    </div>
                  </div>
